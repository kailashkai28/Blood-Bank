...
if(isset($_POST['login'])){
    ...
    if($row = $result->fetch_assoc()){
            ...
            if(isset($_POST['remmember_me'])){
                ...
                setcookie("user_email1", $email, time()+60*5);
            }
            header("Location:myaccount1.php");
            exit();
...
<main role="main" class="container" >
     ...
     <h2 style="text-align:center;"><span style='font-size:100px;'>&#9786;</span>Not a Receiver?&nbsp;<a href="index1.php">Click here</a>&nbsp; if you are a Hospital<span style='font-size:100px;'>&#9786;</span></h2>
    
 <form class="form-signin" method="post" action="index2.php">
  
      <b style="font-size:20px;">Receiver Login</b>(New user, <a href="register.php">click here</a>)
     <br>
